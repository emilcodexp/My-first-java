...
//				grabCity("[50% Off!][Group Tours Included] 5-Day Trip to Onsen [Kyoto]") ➞ "Kyoto"
		...
		String grabCity1 = "[Last Day!] Beer Festival [toronto]";
		String grabCity2 = "Cheese Factory Tour [Portland]";
		String grabCity3 = "[50% Off!][Group Tours Included] 5-Day Trip to Onsen [Kyoto]";
		
		System.out.println(grabCity1.substring(grabCity1.indexOf(""),grabCity1.length()-1 ));
		System.out.println(grabCity2.substring(grabCity2.indexOf("P"),grabCity2.length()-1 ));
		System.out.println(grabCity3.substring(grabCity3.indexOf("K"),grabCity3.length()-1 ));
	}
